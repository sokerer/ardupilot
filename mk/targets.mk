...
BOARDS = apm1 apm2 apm2beta apm1-1280 px4 px4-v1 px4-v2 px4-v4 sitl flymaple linux erle pxf navio raspilot bbbmini minlure erlebrain2 bhat qflight pxfmini
BOARDS += vrbrain
