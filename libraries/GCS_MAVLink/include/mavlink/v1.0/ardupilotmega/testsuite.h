...
static void mavlink_test_monitoring(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
	...
	mavlink_monitoring_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        	packet1.data_value_1 = packet_in.data_value_1;
        	packet1.voltage_1 = packet_in.voltage_1;
        	packet1.data_value_2 = packet_in.data_value_2;
        	packet1.voltage_2 = packet_in.voltage_2;
        	packet1.data_value_3 = packet_in.data_value_3;
        	packet1.voltage_3 = packet_in.voltage_3;
        	packet1.data_value_4 = packet_in.data_value_4;
	...
	mavlink_msg_monitoring_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_monitoring_pack(system_id, component_id, &msg , packet1.data_value_1 , packet1.voltage_1 , packet1.data_value_2 , packet1.voltage_2 , packet1.data_value_3 , packet1.voltage_3 , packet1.data_value_4 , packet1.voltage_4 );
	mavlink_msg_monitoring_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_monitoring_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.data_value_1 , packet1.voltage_1 , packet1.data_value_2 , packet1.voltage_2 , packet1.data_value_3 , packet1.voltage_3 , packet1.data_value_4 , packet1.voltage_4 );
	mavlink_msg_monitoring_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
	...
	mavlink_msg_monitoring_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
	mavlink_msg_monitoring_send(MAVLINK_COMM_1 , packet1.data_value_1 , packet1.voltage_1 , packet1.data_value_2 , packet1.voltage_2 , packet1.data_value_3 , packet1.voltage_3 , packet1.data_value_4 , packet1.voltage_4 );
	mavlink_msg_monitoring_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
